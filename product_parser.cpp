...
{
    Product* bookprod = new Book(categoryID(), prodName_,price_,qty_,author_, isbn_);
    return bookprod;
...
{
    Product* clothingprod = new Clothing(categoryID(), prodName_,price_,qty_,size_, brand_);
    return clothingprod;
...
{
    Product* movieprod = new Movie(categoryID(), prodName_,price_,qty_,genre_, rating_);
    return movieprod;
